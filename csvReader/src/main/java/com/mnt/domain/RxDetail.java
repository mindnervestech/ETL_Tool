...
public class RxDetail extends BaseDomain{
	...
	public String getMonthFilled() {
		return monthFilled;
	}
	public void setMonthFilled(String monthFilled) {
	...
	public String getSubrogationAmt() {
		return subrogationAmt;
	}
	public void setSubrogationAmt(String subrogationAmt) {
