...
public class PremiumDetail extends BaseDomain{
	...
	public String getMonthlyTotalMa() {
		return monthlyTotalMa;
	}
	public void setMonthlyTotalMa(String monthlyTotalMa) {
		this.monthlyTotalMa = monthlyTotalMa;
	}
	public String getMonthlyTotalPartd() {
		return monthlyTotalPartd;
	}
	public void setMonthlyTotalPartd(String monthlyTotalPartd) {
